...
<b>MSGWay SMS Plugin for WordPress and Gravity Form</b>
...
== Installation ==
1. Install MSGWay SMS Pro Gv extension on your WordPress CMS.
2. Now, go to the setting section which is added to Gravity WordPress menu, choose "تنظیمات", then "تنظیمات پیامک" and enter your MSGWay gateway and the number you want to use when you're sending an SMS.
